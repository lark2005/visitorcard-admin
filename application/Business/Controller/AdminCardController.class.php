...
class AdminCardController extends AdminDictionaryController {
	...
	function index(){
		...
		foreach ($result as $n=> $r) {
			...
			$result[$n]['str_manage'] = '<a href="' . U("AdminCard/add", array("parent" => $r['dic_id'])) . '">'.L('ADD_SUB_CATEGORY').'</a> | <a href="' . U("AdminCard/edit", array("id" => $r['dic_id'])) . '">'.L('EDIT').'</a> | <a class="js-ajax-delete" href="' . U("AdminCard/delete", array("id" => $r['dic_id'])) . '">'.L('DELETE').'</a> ';
